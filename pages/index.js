  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        ...
        <ParticlesContainer/>
        {/* avatar img */}
        <motion.div variants={fadeIn('up', 0.4)} initial="hidden" animate="show" exit='hidden' transition={{ duration: 1, ease: 'easeInOut' }} className="w-full h-full max-w-[737px] max-h-[678px] absolute -bottom-32 lg:bottom-0 lg:right-[8%]">
          <Avatar />
        </motion.div>
      </div>
    </div>
